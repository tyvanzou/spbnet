...
data_dir = root_dir / "datamodule"

GRIDAY_PATH = os.path.join(data_dir.absolute(), "libs/GRIDAYS/scripts/grid_gen")
FF_PATH = os.path.join(data_dir.absolute(), "libs/GRIDAYS/FF")
...
def make_prepared_data(
    ...
    max_length = kwargs.get("max_length", 120.0)
